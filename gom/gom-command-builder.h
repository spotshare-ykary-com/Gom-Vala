...
#include "gom-filter.h"//patched
//patched

GType       gom_command_builder_get_resource_type     (GomCommandBuilder *builder);
void        gom_command_builder_set_resource_type     (GomCommandBuilder *builder, GType resource_type);
guint       gom_command_builder_get_offset            (GomCommandBuilder *builder);
void        gom_command_builder_set_offset            (GomCommandBuilder *builder, guint offset);
GType       gom_command_builder_get_m2m_type          (GomCommandBuilder *builder);
gchar       *gom_command_builder_get_m2m_table        (GomCommandBuilder *builder);
guint       gom_command_builder_get_limit             (GomCommandBuilder *builder);
void        gom_command_builder_set_limit             (GomCommandBuilder *builder, guint limit);
